...
function animElementTransition(container, inOutTransition, from) {
    ...
    if (inOutTransition) {
        gsap.fromTo(title, {translateX: from ? '-25px' : '25px', opacity: 0}, {translateX: '0', opacity: 1, duration: 1, delay: .8});
    } else {
        gsap.fromTo(title, {translateX: '0'}, {translateX: from ? '-70.72135785007072vw' : '70.72135785007072vw', duration: 1.5, ease: customEase});
    }
}
